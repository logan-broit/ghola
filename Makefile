.PHONY: all extension server service clients test dev-up dev-down clean smoke-predictive smoke-predictive-down
...
# Brings up an isolated Compose project (postgres + melange-stub +
...
smoke-predictive:
	$(SMOKE_COMPOSE) up -d --build postgres melange mentat ch-init chapterhouse ghola
