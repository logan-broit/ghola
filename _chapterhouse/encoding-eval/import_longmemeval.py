...
Flags:
    ...
    --source      path to LongMemEval-S cleaned JSON
                  (default /home/loganb/longmemeval-ghola/data/longmemeval_s_cleaned.json)
...
DEFAULT_SOURCE = Path("/home/loganb/longmemeval-ghola/data/longmemeval_s_cleaned.json")
